...
// Servo adjustment
#define _DUTY_MAX 2105  // Servo angle: D degree
#define _DUTY_NEU 1500  // Servo angle: 0 degree
#define _DUTY_MIN 994  // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 84 // Replace with |D - E| degree
...
void loop() {
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(30, 0.5)); // Replace n with your desired value
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1315 + -7.31*a_value + 0.0144*a_value*a_value + -9.75*0.000001*a_value*a_value*a_value;
}
